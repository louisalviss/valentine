...
fs.writeFileSync(path.join(outDir, 'capture.json'), JSON.stringify({
  version:'1.0', reference_id:referenceId, local_url:localUrl, captured_at:new Date().toISOString(), states:captures
}, null, 2));
console.log(`REFERENCE_LOCAL_CAPTURE_OK id=${referenceId} states=${captures.length}`);
